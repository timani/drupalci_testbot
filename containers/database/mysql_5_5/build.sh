...
docker ps | grep "drupal/testbot-mysql_5_5" | awk '{print $1}' | grep -v CONTAINER | xargs -n1 -I {} docker stop {}
docker ps -a | grep "drupal/testbot-mysql_5_5" | awk '{print $1}' | grep -v CONTAINER | xargs -n1 -I {} docker rm {}
