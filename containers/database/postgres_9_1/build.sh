...
docker ps | grep "drupal/testbot-pgsql_9_1" | awk '{print $1}' | grep -v CONTAINER | xargs -n1 -I {} docker stop {}
docker ps -a | grep "drupal/testbot-pgsql_9_1" | awk '{print $1}' | grep -v CONTAINER | xargs -n1 -I {} docker rm {}
